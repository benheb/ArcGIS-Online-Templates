...
function showResults(candidates) {
  ...
  dojo.every(candidates, function (candidate) {
    if (candidate.score > 80) {
      ...
      var minx = parseFloat(candidate.attributes.West_Lon);
      var miny = parseFloat(candidate.attributes.South_Lat);
      var maxx = parseFloat(candidate.attributes.East_Lon);
      var maxy = parseFloat(candidate.attributes.North_Lat);
